...
function Circlebar(prefs) {
    ...
    this.initialise = function() {
        ...
        that.maxValue = parseInt(attribs.circleMaxvalue) || parseInt(prefs.maxValue) || 10;
        that.counter = parseInt(attribs.circleCounter) || parseInt(prefs.counter) || 700;
        that.dialWidth = parseInt(attribs.circleDialwidth) || parseInt(prefs.dialWidth) || 10;
        that.size = attribs.circleSize || prefs.size || "350px";
        ...
        that.skin = attribs.circleSkin || prefs.skin || "150 ";
        ...
        if (that.type == "timer") {
            that.timer = setInterval(function() {
                if (that.value < that.maxValue) {
                    that.value += parseInt(that.counter / 700);
